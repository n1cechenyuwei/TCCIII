! function (t, n) {
  ...
  return function (t) {
    ...
    }, s), f.DataSet = l, i(l.prototype, {
      view: l.prototype.createView
    }), l.version = "0.10.1", t.exports = l
  }, function (t, n) {
    function e(t, n) {
    ...
    function r(t) {
      ...
      return n.stream = function (t) {
          ...
          return arguments.length ? (I = null == t ? (A = O = _ = m = null, c.a) : Object(u.a)(A = +t[0][0], O = +t[0][1], _ = +t[1][0], m = +t[1][1]), l()) : null == A ? null : [
            [A, O],
            [_, m]
          ]
        }, n.scale = function (t) {
    ...
    function r(t) {
      ...
      return n.stream = function (t) {
          ...
          return arguments.length ? (z = Object(p.a)(e, L = t * t), l()) : Object(f.u)(L)
        }, n.fitExtent = Object(h.a)(n), n.fitSize = Object(h.b)(n),
        function () {
          return d = t.apply(this, arguments), n.invert = d.invert && function (t) {
            return (t = j.invert((t[0] - g) / E, (b - t[1]) / E)) && [t[0] * f.h, t[1] * f.h]
          }, r()
    ...
    ! function (t, e) {
      ...
      function r(t, n) {
        var r, i, o = e(t),
          u = 0;
        if (2 === n)
          for (i = 0; i < t.length; i++) u += (r = t[i] - o) * r;
        else
          for (i = 0; i < t.length; i++) u += Math.pow(t[i] - o, n);
        return u
      }
      ...
      N.prototype.train = function (t, n) {
        ...
        var o = {};
        for (n in e)
          for (var u in o[n] = 0, e[n]) o[n] += e[n][u];
        return o
      ...
      t.linearRegression = function (t) {
        ...
        for (r = 0; r < n.length; r++)
          if (1 === e) a.push([n[r]]);
            ...
            for (o = t(n.slice(r + 1, n.length), e - 1), i = 0; i < o.length; i++)(u = o[i]).unshift(n[r]), a.push(u);
        return a
      }, t.combinationsReplacement = function t(n, e) {
        for (var r = [], i = 0; i < n.length; i++)
          if (1 === e) r.push([n[i]]);
          else
            for (var o = t(n.slice(i, n.length), e - 1), u = 0; u < o.length; u++) r.push([n[i]].concat(o[u]));
        return r
      ...
      }, t.quickselect = l, t.sign = q, t.numericSort = a, Object.defineProperty(t, "__esModule", {
        value: !0
      })
    })
  }, function (t, n, e) {
    ...
    n.a = function (t, n) {
      ...
      var c = function (t) {
          var n, e, r, u, c, f, s, l = [],
            h = t[0].length;
          for (s = 0; s < h; ++s) e = (n = t[0][s])[0][0], r = n[0][1], u = n[1][1], c = n[2][0], f = n[2][1], l.push(i([
            [e + a.k, r + a.k],
            [e + a.k, u - a.k],
            [c - a.k, u - a.k],
            [c - a.k, f + a.k]
          ], 30));
          for (s = t[1].length - 1; s >= 0; --s) e = (n = t[1][s])[0][0], r = n[0][1], u = n[1][1], c = n[2][0], f = n[2][1], l.push(i([
            [c - a.k, f - a.k],
            [c - a.k, u + a.k],
            [e + a.k, u + a.k],
            [e + a.k, r - a.k]
      ...
      b = function (t) {
        ...
        return e._parseStateExpression = function (t) {
          ...
          if (r._source = {
              source: t,
              options: e
            }, e) e = r._preparseOptions(e), r.origin = i.getConnector(e.type)(t, e, r);
    ...
    function o(t, n) {
      ...
      for (f = [], a = new Array(t.length), u = new v.b, c = new v.b;;)
        if (o = h.c, d && (!o || d[1] < o.y || d[1] === o.y && d[0] < o.x)) d[0] === e && d[1] === r || (Object(s.a)(d), e = d[0], r = d[1]), d = t.pop();
        else {
          if (!o) break;
          Object(s.b)(o.arc)
        } if (Object(l.d)(), n) {
      ...
      triangles: function () {
        ...
        return this.cells.forEach(function (e, i) {
          if (u = (o = e.halfedges).length)
            for (var o, u, a, c = e.site, f = -1, s = n[o[u - 1]], l = s.left === c ? s.right : s.left; ++f < u;) a = l, l = (s = n[o[f]]).left === c ? s.right : s.left, a && l && i < a.index && i < l.index && r(c, a, l) < 0 && t.push([c.data, a.data, l.data])
        }), t
      },
      links: function () {
    ...
    function r(t, n, e, r) {
      ...
      return function (i) {
        ...
        function d(i, o) {
          var a = l(i, o);
          if (b && y.push([i, o]), E) j = i, O = o, _ = a, E = !1, a && (T.lineStart(), T.point(i, o));
            ...
            polygonEnd: function () {
              var n = function () {
                  for (var n = 0, e = 0, i = b.length; e < i; ++e)
                    for (var o, u, a = b[e], c = 1, f = a.length, s = a[0], l = s[0], h = s[1]; c < f; ++c) o = l, u = h, l = (s = a[c])[0], h = s[1], u <= r ? h > r && (l - o) * (r - u) > (h - u) * (t - o) && ++n : h <= r && (l - o) * (r - u) < (h - u) * (t - o) && --n;
                  return n
                }(),
                e = M && n,
    ...
    n.b = function () {
      ...
      return e = {
        ...
        extent: function (r) {
          return arguments.length ? (i = +r[0][0], o = +r[0][1], u = +r[1][0], a = +r[1][1], t = n = null, e) : [
            [i, o],
            [u, a]
          ]
        }
    ...
    function i(t) {
      ...
      return f.scale = function (t) {
        ...
        return arguments.length ? (null == t ? v = e = i = c = null : (v = +t[0][0], e = +t[0][1], i = +t[1][0], c = +t[1][1]), n()) : null == v ? null : [
          [v, e],
          [i, c]
        ]
      }, n()
    ...
    n.a = function (t) {
      function n(t, n) {
        ...
        var r, f = [],
          ...
          v = s <= 0,
          d = !1;
        for (t.charCodeAt(s - 1) === a && --s, t.charCodeAt(s - 1) === c && --s;
          (r = e()) !== o;) {
    ...
    function r(t, n) {
      var e, r, o, c, f, s = new a(t),
        l = +t.value && (s.value = t.value),
        h = [s];
      for (null == n && (n = i); e = h.pop();)
        if (l && (e.value = +e.data.value), (o = n(e.data)) && (f = o.length))
          for (e.children = new Array(f), c = f - 1; c >= 0; --c) h.push(r = e.children[c] = new a(o[c])), r.parent = e, r.depth = e.depth + 1;
    ...
    r.prototype = i.prototype = {
      ...
      entries: function () {
        var t = [];
        for (var n in this) n[0] === o && t.push({
          key: n.slice(1),
          value: this[n]
        });
        return t
    ...
    n.a = function (t) {
      ...
      remove: function (t) {
        ...
        var n, e, r, a = t.U,
          c = t.L,
          f = t.R;
        if (e = c ? f ? u(f) : c : f, a ? a.L === t ? a.L = e : a.R = e : this._ = e, c && f ? (r = e.C, e.C = t.C, e.L = c, c.U = e, e !== f ? (a = e.U, e.U = t.U, t = e.R, a.L = t, e.R = f, f.U = e) : (e.U = a, a = e, t = e.R)) : (r = t.C, t = e), t && (t.U = a), !r)
          if (t && t.C) t.C = !1;
          else {
            do {
              if (t === this._) break;
      ...
      if (t.forEach(function (t) {
        ...
        for (var h, p, v = s[0];;) {
          ...
          do {
            if (d.v = d.o.v = !0, d.e) {
              if (g)
                for (c = 0, f = h.length; c < f; ++c) a.point((p = h[c])[0], p[1]);
              else u(d.x, d.n.x, 1, a);
              d = d.n
            } else {
              if (g)
                for (h = d.p.z, c = h.length - 1; c >= 0; --c) a.point((p = h[c])[0], p[1]);
    ...
    n.a = function (t, n) {
      var e, i, o = t.length,
        ...
        f = 0;
      if (null == n)
        for (; ++a < o;) isNaN(e = Object(r.a)(t[a])) || (f += (i = e - c) * (e - (c += i / ++u)));
      else
        for (; ++a < o;) isNaN(e = Object(r.a)(n(t[a], a, t))) || (f += (i = e - c) * (e - (c += i / ++u)));
      if (u > 1) return f / (u - 1)
    }
  }, function (t, n, e) {
    "use strict";
    ...
    n.a = function (t, n) {
      ...
      for (var s = 0, l = t.length; s < l; ++s)
        if (p = (h = t[s]).length)
          for (var h, p, v = h[p - 1], d = v[0], g = v[1] / 2 + o.q, b = Object(o.t)(g), y = Object(o.g)(g), j = 0; j < p; ++j, d = _, b = w, y = x, v = O) {
            var O = h[j],
              _ = O[0],
              m = O[1] / 2 + o.q,
              w = Object(o.t)(m),
    ...
    function r(t, n) {
      ...
      var f = function (t, n) {
        ...
        var y, j = Object(o.h)(n),
          O = 1 / j,
          _ = 2 * i * j,
          m = (-h * j - (-3 * u + l * f) * _ * (1 - i)) / (h * h),
          w = -O * _,
          x = -O * (u * c * m + p * f * _),
          E = -2 * O * (s * (.5 * m / v) - 2 * u * v * _),
          M = 4 * t / o.s;
    ...
    ! function (n) {
      ...
      c.getListeners = function (t) {
        ...
        var e, r = this.getListenersAsObject(t),
          i = "object" == typeof n;
        for (e in r) r.hasOwnProperty(e) && -1 === o(r[e], n) && r[e].push(i ? n : {
          listener: n,
          once: !1
        });
        return this
        ...
        if ("object" != typeof n || n instanceof RegExp)
          ...
          for (r in n) n.hasOwnProperty(r) && (i = n[r]) && ("function" == typeof i ? o.call(this, r, i) : u.call(this, r, i));
        return this
        ...
        for (o in u)
          if (u.hasOwnProperty(o))
            for (e = u[o].slice(0), i = 0; i < e.length; i++) !0 === (r = e[i]).once && this.removeListener(t, r.listener), r.listener.apply(this, n || []) === this._getOnceReturnValue() && this.removeListener(t, r.listener);
        return this
    ...
    t.exports = function t(n) {
      ...
      if (r(n))
        for (var i = 0; i < n.length; i += 1) t(n[i], e);
      else e.push(n);
      return e
    }
  }, function (t, n) {
    ...
    function a(t) {
      ...
      t: for (h = 3; h < f; ++h) {
        ...
        for (a.previous = n, a.next = e, n.next = e.previous = e = a, s = o(n);
          (a = a.next) !== e;)(l = o(a)) < s && (n = a, s = l);
        e = n.next
      }
      for (n = [e._], a = e;
      ...
      for (var n, e, f = 0, s = (t = Object(c.a)(c.b.call(t))).length, l = []; f < s;) n = t[f], e && i(e, n) ? ++f : (e = function (t) {
        ...
        for (e = 0; e < t.length - 1; ++e)
          for (i = e + 1; i < t.length; ++i)
            if (r(u(t[e], t[i]), n) && r(u(t[e], n), t[i]) && r(u(t[i], n), t[e]) && o(a(t[e], t[i], n), t)) return [t[e], t[i], n];
        throw new Error
      }(l, n)), f = 0);
      return e
    }
    ...
    n.a = function (t) {
      ...
      var i, o = Object(r.a)(t.transform),
        u = 1 / 0,
        a = u,
        c = -u,
        f = -u;
          ...
          Re = function t(n) {
            ...
            function te(t, n, e) {
              for (var r = -1, i = t.length; ++r < i;) {
                var o = t[r],
                  u = n(o);
                if (null != u && (a === D ? u == u && !io(u) : e(u, a))) var a = u,
                  c = o
              }
              return c
            }
            ...
            function Xe(t, n, e, r) {
              ...
              for (t === n && (n = Mr(n)), e && (a = p(t, T(e))); ++o < u;)
                for (var c = 0, f = n[o], s = e ? e(f) : f;
                  (c = i(a, s, c, r)) > -1;) a !== t && iu.call(a, c, 1), iu.call(t, c, 1);
              return t
            }
            ...
            function or(t, n, e, r) {
              ...
              for (var i = 0, o = null == t ? 0 : t.length, u = n != n, a = null === n, c = io(n), f = n === D; i < o;) {
                var s = pu((i + o) / 2),
                  ...
                  d = io(l);
                if (u) var g = r || v;
                else g = f ? v && (r || h) : a ? v && h && (r || !p) : c ? v && h && !p && (r || !d) : !p && !d && (r ? l <= n : l < n);
                g ? i = s + 1 : o = s
              }
              return Ou(o, Ot)
            }
            ...
            function vr(t, n, e) {
              ...
              for (var i = -1, o = Co(r); ++i < r;)
                for (var u = t[i], a = -1; ++a < r;) a != i && (o[i] = Qn(o[i] || u, t[a], n, e));
            ...
            function Cr(t, n) {
              return function (e, r) {
                ...
                for (var i = e.length, o = n ? i : -1, u = Ao(e);
                  (n ? o-- : ++o < i) && !1 !== r(u[o], o, u););
                return e
              }
            }
            ...
            function Gr(t) {
              return function (n, e, r) {
                return r && "number" != typeof r && li(n, e, r) && (e = r = D), n = uo(n), e === D ? (e = n, n = 0) : e = uo(e), r = r === D ? n < e ? 1 : -1 : uo(r),
                  function (t, n, e, r) {
            ...
            var La = $u(function (t, n) {
              ...
              tc = kr(function (t, n) {
                if (vi(n) || Yi(n)) Tr(n, vo(n), t);
                  ...
                  for (var e in n) Uo.call(n, e) && Un(t, e, n[e])
              }),
              nc = kr(function (t, n) {
                Tr(n, go(n), t)
              }),
            ...
            return e.after = function (t, n) {
              ...
              return n = uo(n), e === D ? (e = n, n = 0) : e = uo(e), t = fo(t),
                function (t, n, e) {
              ...
              var o, u, a = ec({}, n.imports, i.imports, $r),
                c = vo(a),
                f = S(a, c),
                s = 0,
                l = n.interpolate || Bn,
              ...
              chain: !1
            }), e.VERSION = "4.17.4", c(["bind", "bindKey", "curry", "curryRight", "partial", "partialRight"], function (t) {
              e[t].placeholder = e
    ...
    n.c = function (t) {
      ...
      var c, f, s, l, h, p, v, d, g, b, y, j, O = a.b.length,
        _ = !0;
      for (c = 0; c < O; ++c)
        if (f = a.b[c]) {
    ...
    i.assign(r.prototype, {
      ...
      void 0 === n && (n = {});
      var u, a = new r(t, n = i.assign({}, o, n)),
        c = [a];
      if (!e && !t.collapsed)
        for (; u = c.pop();)
          if (!u.data.collapsed) {
    ...
    var p, v, d, g, b, y, j, O, _, m, w = e(29),
      x = e(103),
      E = e(35),
      M = e(4),
      T = e(22),
    ...
    var p, v, d, g, b, y, j, O, _, m, w, x, E, M, T, S, k = e(4),
      C = e(20),
      P = e(22),
      N = {
        sphere: C.a,
    ...
    n.a = function (t, n) {
      ...
      if (null == n)
        ...
        for (; ++u < i;) isNaN(e = Object(r.a)(n(t[u], u, t))) ? --o : a += e;
      if (o) return a / o
    }
  }, function (t, n, e) {
    "use strict";
    ...
    function o() {
      ...
      var e, o, c, f, s, l, h, p, v, d, g, b, y = 10,
        j = y,
        O = 90,
        _ = 360,
        m = 2.5;
      return t.lines = function () {
        ...
        return arguments.length ? (f = +n[0][0], c = +n[1][0], p = +n[0][1], h = +n[1][1], f > c && (n = f, f = c, c = n), p > h && (n = p, p = h, h = n), t.precision(m)) : [
          [f, p],
          [c, h]
        ]
      }, t.extentMinor = function (n) {
        return arguments.length ? (o = +n[0][0], e = +n[1][0], l = +n[0][1], s = +n[1][1], o > e && (n = o, o = e, e = n), l > s && (n = l, l = s, s = n), t.precision(m)) : [
          [o, l],
          [e, s]
        ]
      }, t.step = function (n) {
    ...
    n.a = Object(r.a)(function () {
      ...
      var o;
      if (null == t) o = e * i.l, r.point(-i.o, o), r.point(0, o), r.point(i.o, o), r.point(i.o, 0), r.point(i.o, -o), r.point(0, -o), r.point(-i.o, -o), r.point(-i.o, 0), r.point(-i.o, o);
      ...
      return Object(a.a)(e, function (t) {
        ...
        return {
          ...
          point: function (p, v) {
            ...
            if (!n && (a = i = b) && t.lineStart(), b !== i && (!(d = c(n, g)) || Object(u.a)(n, d) || Object(u.a)(g, d)) && (g[0] += o.i, g[1] += o.i, b = e(g[0], g[1])), b !== i) s = 0, b ? (t.lineStart(), d = c(g, n), t.point(d[0], d[1])) : (d = c(n, g), t.point(d[0], d[1]), t.lineEnd()), n = d;
            else if (h && n && l ^ b) {
              var j;
    ...
    n.a = function () {
      ...
      var e, a, c, f, s, l, h = Object(i.a)(),
        ...
        v = Object(o.b)().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
        d = {
          point: function (t, n) {
            l = [t, n]
          }
      ...
      return t.invert = function (t) {
        ...
        var e = h.scale(),
          i = +t[0],
          o = +t[1];
        return c = h.translate(t).clipExtent([
          [i - .455 * e, o - .238 * e],
          [i + .455 * e, o + .238 * e]
        ]).stream(d), f = p.translate([i - .307 * e, o + .201 * e]).clipExtent([
          [i - .425 * e + r.i, o + .12 * e + r.i],
          [i - .214 * e - r.i, o + .234 * e - r.i]
        ]).stream(d), s = v.translate([i - .205 * e, o + .212 * e]).clipExtent([
          [i - .214 * e + r.i, o + .166 * e + r.i],
          [i - .115 * e - r.i, o + .234 * e - r.i]
        ]).stream(d), n()
    ...
    n.a = function () {
      ...
      return s = {
        ...
        clipExtent: function (r) {
          return arguments.length ? (y = null == r ? (b = n = e = u = null, o.a) : Object(i.a)(b = +r[0][0], n = +r[0][1], e = +r[1][0], u = +r[1][1]), t()) : null == b ? null : [
            [b, n],
            [e, u]
          ]
        },
    ...
    function u(t, n, e) {
      for (var u, a = [
        ...
        ], c = a[2], f = 0; f < 3; ++f, c = u) u = a[f], c.v = r(u[1] - c[1], c[3], c[2], u[3], u[2], u[0] - c[0]), c.point = [0, 0];
    ...
    n.c = function (t, n, e) {
      var i, o, u;
      return t ? (i = r(t, e), n ? (o = r(n, 1 - e), u = o[1] * o[1] + e * i[0] * i[0] * o[0] * o[0], [
    ...
    n.a = function () {
      ...
      return e.parallel = function (r) {
        ...
        return t = a(t), t.sphere = function () {
          t.polygonStart();
          var n, e = c.radius(89.99)().coordinates[0],
            r = e.length - 1,
            i = -1;
    ...
    function r(t, n) {
      var e, r = Object(o.r)(18, 36 * Object(o.a)(n) / o.s),
        i = Object(o.n)(r),
        a = r - i,
        c = (e = u[i])[0],
        f = e[1],
    ...
    ! function (t, r) {
      ...
      t.geoAlbersUsa = function () {
        ...
        var a, c, f, s, l, h, p = n.geoAlbers(),
          ...
          d = n.geoConicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
          g = {
            point: function (t, n) {
              h = [t, n]
            }
        ...
        return t.invert = function (t) {
          ...
          var n = p.scale(),
            e = +t[0],
            i = +t[1];
          return f = p.translate(t).clipExtent([
            [e - .455 * n, i - .238 * n],
            [e + .455 * n, i + .238 * n]
          ]).stream(g), s = v.translate([e - .307 * n, i + .201 * n]).clipExtent([
            [e - .425 * n + u, i + .12 * n + u],
            [e - .214 * n - u, i + .234 * n - u]
          ]).stream(g), l = d.translate([e - .205 * n, i + .212 * n]).clipExtent([
            [e - .214 * n + u, i + .166 * n + u],
            [e - .115 * n - u, i + .234 * n - u]
          ]).stream(g), r()
        }, t.fitExtent = function (n, e) {
        ...
        return t.invert = function (t) {
          ...
          var n = g.scale(),
            e = +t[0],
            i = +t[1];
          return f = g.translate(t).clipExtent([
            [e - .455 * n, i - .238 * n],
            [e + .455 * n, i + .238 * n]
          ]).stream(m), s = b.translate([e - .307 * n, i + .201 * n]).clipExtent([
            [e - .425 * n + u, i + .12 * n + u],
            [e - .214 * n - u, i + .233 * n - u]
          ]).stream(m), l = y.translate([e - .205 * n, i + .212 * n]).clipExtent([
            [e - .214 * n + u, i + .166 * n + u],
            [e - .115 * n - u, i + .233 * n - u]
          ]).stream(m), h = j.translate([e + .35 * n, i + .224 * n]).clipExtent([
            [e + .312 * n + u, i + .2064 * n + u],
            [e + .385 * n - u, i + .233 * n - u]
          ]).stream(m), p = O.translate([e - .492 * n, i + .09 * n]).clipExtent([
            [e - .4243 * n + u, i + .0903 * n + u],
            [e - .3233 * n - u, i + .1197 * n - u]
          ]).stream(m), v = _.translate([e - .408 * n, i + .018 * n]).clipExtent([
            [e - .4244 * n + u, i - .0519 * n + u],
            [e - .3824 * n - u, i + .0895 * n - u]
          ]).stream(m), r()
        }, t.fitExtent = function (n, e) {
          return i(t, n, e)
        }, t.fitSize = function (n, e) {
        ...
        return t.invert = function (t) {
          ...
          var n = h.scale(),
            e = +t[0],
            i = +t[1];
          return f = h.translate(t).clipExtent([
            [e - .06857 * n, i - .1288 * n],
            [e + .13249 * n, i + .06 * n]
          ]).stream(v), s = p.translate([e + .1 * n, i - .094 * n]).clipExtent([
            [e - .1331 * n + u, i + .053457 * n + u],
            [e - .0354 * n - u, i + .08969 * n - u]
          ]).stream(v), r()
        }, t.fitExtent = function (n, e) {
          return i(t, n, e)
        }, t.fitSize = function (n, e) {
        ...
        var a, c, f, s, l, h, p = n.geoConicConformal().rotate([10, -39.3]).parallels([0, 60]),
          ...
          d = n.geoConicConformal().rotate([27.8, -38.6]).parallels([0, 60]),
          g = {
            point: function (t, n) {
              h = [t, n]
            }
        ...
        return t.invert = function (t) {
          ...
          return f = p.translate(t).clipExtent([
            [e - .0115 * n, i - .1138 * n],
            [e + .2105 * n, i + .0673 * n]
          ]).stream(g), s = v.translate([e - .0265 * n, i + .025 * n]).clipExtent([
            [e - .0388 * n + u, i + .0093 * n + u],
            [e - .0116 * n - u, i + .0368 * n - u]
          ]).stream(g), l = d.translate([e - .045 * n, i + -.02 * n]).clipExtent([
            [e - .0778 * n + u, i - .0413 * n + u],
            [e - .0117 * n - u, i + .0091 * n - u]
          ]).stream(g), r()
        }, t.fitExtent = function (n, e) {
          return i(t, n, e)
        }, t.fitSize = function (n, e) {
        ...
        var a, c, f, s, l, h = n.geoMercator().rotate([80, 1.5]),
        ...
        return t.invert = function (t) {
          ...
          return f = h.translate(t).clipExtent([
            [e - .0262 * n, i - .0734 * n],
            [e + .1741 * n, i + .079 * n]
          ]).stream(v), s = p.translate([e - .06 * n, i - .04 * n]).clipExtent([
            [e - .0857 * n + u, i - .0676 * n + u],
            [e - .0263 * n - u, i - .026 * n - u]
          ]).stream(v), r()
        }, t.fitExtent = function (n, e) {
          return i(t, n, e)
        }, t.fitSize = function (n, e) {
        ...
        return t.invert = function (t) {
          ...
          var n = v.scale(),
            e = +t[0],
            i = +t[1];
          return f = v.translate(t).clipExtent([
            [e - .059 * n, i - .3835 * n],
            [e + .4498 * n, i + .3375 * n]
          ]).stream(y), s = d.translate([e - .087 * n, i + .17 * n]).clipExtent([
            [e - .1166 * n + u, i + .2582 * n + u],
            [e - .06 * n - u, i + .32 * n - u]
          ]).stream(y), l = g.translate([e - .092 * n, i - 0 * n]).clipExtent([
            [e - .114 * n + u, i - .013 * n + u],
            [e - .0594 * n - u, i + .0133 * n - u]
          ]).stream(y), h = b.translate([e - .089 * n, i - .0265 * n]).clipExtent([
            [e - .089 * n + u, i + .0154 * n + u],
            [e - .0588 * n - u, i + .0391 * n - u]
          ]).stream(y), r()
        }, t.fitExtent = function (n, e) {
          return i(t, n, e)
        }, t.fitSize = function (n, e) {
        ...
        var a, c, f, s, l, h, p = n.geoConicEquidistant().rotate([-136, -22]).parallels([40, 34]),
          ...
          d = n.geoConicEquidistant().rotate([-126, -19]).parallels([40, 34]),
          g = {
            point: function (t, n) {
              h = [t, n]
            }
        ...
        return t.invert = function (t) {
          ...
          return f = p.translate(t).clipExtent([
            [e - .1352 * n, i - .1091 * n],
            [e + .117 * n, i + .098 * n]
          ]).stream(g), s = v.translate([e - .0425 * n, i - .005 * n]).clipExtent([
            [e - .135 * n + u, i - .1093 * n + u],
            [e - .0397 * n - u, i - .027 * n - u]
          ]).stream(g), l = d.translate(t).clipExtent([
            [e - .0399 * n + u, i + .0471 * n + u],
            [e + .051 * n - u, i + .1114 * n - u]
          ]).stream(g), r()
        }, t.fitExtent = function (n, e) {
          return i(t, n, e)
        }, t.fitSize = function (n, e) {
        ...
        var a, c, f, s, l, h, p, v, d, g, b, y, j, O, _, m = n.geoConicConformal().rotate([-3, -46.2]).parallels([0, 60]),
        ...
        return t.invert = function (t) {
          ...
          var n = m.scale(),
            e = +t[0],
            i = +t[1];
          return f = m.translate(t).clipExtent([
            [e - .0996 * n, i - .0908 * n],
            [e + .0967 * n, i + .0864 * n]
          ]).stream(B), s = w.translate([e - .12 * n, i + .0575 * n]).clipExtent([
            [e - .14 * n + u, i + .029 * n + u],
            [e - .0996 * n - u, i + .0864 * n - u]
          ]).stream(B), l = x.translate([e - .12 * n, i + .013 * n]).clipExtent([
            [e - .14 * n + u, i + 0 * n + u],
            [e - .0996 * n - u, i + .029 * n - u]
          ]).stream(B), h = E.translate([e - .12 * n, i - .014 * n]).clipExtent([
            [e - .14 * n + u, i - .032 * n + u],
            [e - .0996 * n - u, i + 0 * n - u]
          ]).stream(B), p = M.translate([e - .12 * n, i - .044 * n]).clipExtent([
            [e - .14 * n + u, i - .052 * n + u],
            [e - .0996 * n - u, i - .032 * n - u]
          ]).stream(B), v = T.translate([e - .12 * n, i - .065 * n]).clipExtent([
            [e - .14 * n + u, i - .076 * n + u],
            [e - .0996 * n - u, i - .052 * n - u]
          ]).stream(B), d = S.translate([e + .117 * n, i - .064 * n]).clipExtent([
            [e + .0967 * n + u, i - .076 * n + u],
            [e + .1371 * n - u, i - .052 * n - u]
          ]).stream(B), g = k.translate([e + .116 * n, i - .0355 * n]).clipExtent([
            [e + .0967 * n + u, i - .052 * n + u],
            [e + .1371 * n - u, i - .02 * n - u]
          ]).stream(B), b = C.translate([e + .116 * n, i - .0048 * n]).clipExtent([
            [e + .0967 * n + u, i - .02 * n + u],
            [e + .1371 * n - u, i + .012 * n - u]
          ]).stream(B), y = P.translate([e + .116 * n, i + .022 * n]).clipExtent([
            [e + .0967 * n + u, i + .012 * n + u],
            [e + .1371 * n - u, i + .033 * n - u]
          ]).stream(B), O = R.translate([e + .11 * n, i + .045 * n]).clipExtent([
            [e + .0967 * n + u, i + .033 * n + u],
            [e + .1371 * n - u, i + .06 * n - u]
          ]).stream(B), j = N.translate([e + .115 * n, i + .075 * n]).clipExtent([
            [e + .0967 * n + u, i + .06 * n + u],
            [e + .1371 * n - u, i + .0864 * n - u]
          ]).stream(B), r()
        }, t.fitExtent = function (n, e) {
          return i(t, n, e)
        }, t.fitSize = function (n, e) {
        ...
        var a, c, f, s, l, h, p, v, d, g, b, y, j, O, _, m = n.geoConicConformal().rotate([-10, -53]).parallels([0, 60]),
          ...
          R = n.geoConicConformal().rotate([-14.4, -35.95]).parallels([0, 60]),
          B = {
            point: function (t, n) {
              _ = [t, n]
            }
        ...
        return t.invert = function (t) {
          ...
          var n = m.scale(),
            e = +t[0],
            i = +t[1];
          return f = m.translate([e - .08 * n, i]).clipExtent([
            [e - .51 * n, i - .33 * n],
            [e + .5 * n, i + .33 * n]
          ]).stream(B), s = w.translate([e + .19 * n, i - .275 * n]).clipExtent([
            [e + .14 * n + u, i - .31 * n + u],
            [e + .24 * n - u, i - .24 * n - u]
          ]).stream(B), l = x.translate([e + .19 * n, i - .205 * n]).clipExtent([
            [e + .14 * n + u, i - .24 * n + u],
            [e + .24 * n - u, i - .17 * n - u]
          ]).stream(B), h = E.translate([e + .19 * n, i - .135 * n]).clipExtent([
            [e + .14 * n + u, i - .17 * n + u],
            [e + .24 * n - u, i - .1 * n - u]
          ]).stream(B), p = M.translate([e + .225 * n, i - .147 * n]).clipExtent([
            [e + .21 * n + u, i - .17 * n + u],
            [e + .24 * n - u, i - .12 * n - u]
          ]).stream(B), v = T.translate([e + .153 * n, i - .15 * n]).clipExtent([
            [e + .14 * n + u, i - .17 * n + u],
            [e + .165 * n - u, i - .14 * n - u]
          ]).stream(B), d = S.translate([e + .19 * n, i - .065 * n]).clipExtent([
            [e + .14 * n + u, i - .1 * n + u],
            [e + .24 * n - u, i - .03 * n - u]
          ]).stream(B), g = k.translate([e + .19 * n, i + .005 * n]).clipExtent([
            [e + .14 * n + u, i - .03 * n + u],
            [e + .24 * n - u, i + .04 * n - u]
          ]).stream(B), b = C.translate([e + .29 * n, i - .275 * n]).clipExtent([
            [e + .24 * n + u, i - .31 * n + u],
            [e + .34 * n - u, i - .24 * n - u]
          ]).stream(B), y = P.translate([e + .29 * n, i - .205 * n]).clipExtent([
            [e + .24 * n + u, i - .24 * n + u],
            [e + .34 * n - u, i - .17 * n - u]
          ]).stream(B), j = N.translate([e + .29 * n, i - .135 * n]).clipExtent([
            [e + .24 * n + u, i - .17 * n + u],
            [e + .34 * n - u, i - .1 * n - u]
          ]).stream(B), O = R.translate([e + .29 * n, i - .065 * n]).clipExtent([
            [e + .24 * n + u, i - .1 * n + u],
            [e + .34 * n - u, i - .03 * n - u]
          ]).stream(B), r()
        }, t.fitExtent = function (n, e) {
        ...
        var a, c, f, s, l, h = n.geoMercator().center([105.25, 4]),
        ...
        return t.invert = function (t) {
          ...
          return f = h.translate(t).clipExtent([
            [e - .11 * n, i - .0521 * n],
            [e - .0111 * n, i + .0521 * n]
          ]).stream(v), s = p.translate([e + .09 * n, i - 0 * n]).clipExtent([
            [e - .0111 * n + u, i - .0521 * n + u],
            [e + .1 * n - u, i + .024 * n - u]
          ]).stream(v), r()
        }, t.fitExtent = function (n, e) {
          return i(t, n, e)
        ...
        return t.invert = function (t) {
          ...
          return f = p.translate(t).clipExtent([
            [e - .005 * n, i - .02 * n],
            [e + .038 * n, i + .02 * n]
          ]).stream(g), s = v.translate([e - .025 * n, i - .01 * n]).clipExtent([
            [e - .038 * n + u, i - .02 * n + u],
            [e - .005 * n - u, i + 0 * n - u]
          ]).stream(g), l = d.translate([e - .025 * n, i + .01 * n]).clipExtent([
            [e - .038 * n + u, i - 0 * n + u],
            [e - .005 * n - u, i + .02 * n - u]
          ]).stream(g), r()
        }, t.fitExtent = function (n, e) {
    ...
    var p, v, d, g, b, y, j, O, _, m, w = e(42),
      x = e(142),
      E = e(43),
      M = e(5),
      T = e(26),
    ...
    var p, v, d, g, b, y, j, O, _, m, w, x, E, M, T, S, k = e(5),
      C = e(25),
      P = e(26),
      N = {
        sphere: C.a,
    ...
    n.a = function () {
      ...
      var e, a, c, f, s, l, h, p, v, d, g, b, y = 10,
        j = y,
        O = 90,
        _ = 360,
        m = 2.5;
      return t.lines = function () {
        ...
        return arguments.length ? (a = +n[0][0], e = +n[1][0], l = +n[0][1], s = +n[1][1], a > e && (n = a, a = e, e = n), l > s && (n = l, l = s, s = n), t.precision(m)) : [
          [a, l],
          [e, s]
        ]
      }, t.step = function (n) {
    ...
    n.a = function () {
      ...
      var n, e, a, c, f, s, l = Object(i.a)(),
        ...
        p = Object(o.b)().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
        v = {
          point: function (t, n) {
            s = [t, n]
          }
      ...
      return t.invert = function (t) {
        ...
        var e = l.scale(),
          i = +n[0],
          o = +n[1];
        return a = l.translate(n).clipExtent([
          [i - .455 * e, o - .238 * e],
          [i + .455 * e, o + .238 * e]
        ]).stream(v), c = h.translate([i - .307 * e, o + .201 * e]).clipExtent([
          [i - .425 * e + r.i, o + .12 * e + r.i],
          [i - .214 * e - r.i, o + .234 * e - r.i]
        ]).stream(v), f = p.translate([i - .205 * e, o + .212 * e]).clipExtent([
          [i - .214 * e + r.i, o + .166 * e + r.i],
          [i - .115 * e - r.i, o + .234 * e - r.i]
        ]).stream(v), t
    ...
    ! function (t, r) {
      ...
      t.renderHexJSON = function (t, e, r) {
        ...
        for (i = c; i <= a; i++)
          for (o = s; o <= f; o++) u = "Q" + i + "R" + o, e.hexes[u] = {
            q: i,
            r: o
          };
        return e
      ...
      function t(t) {
        var r = function (t) {
          for (var n, e, r, i, o, u = new c(t, 0), a = [u]; n = a.pop();)
            if (r = n._.children)
              for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) a.push(e = n.children[i] = new c(r[i], i)), e.parent = n;
    ...
    function r(t, n, e) {
      ...
      if (arguments.length > 1) r = function (t, n, e) {
        ...
        for (i = 0, r = new Array(u = t.arcs.length); i < u; ++i) r[i] = i;
      return {
        type: "MultiLineString",
        arcs: Object(o.a)(t, r)
      }
      ...
      return n.forEach(e), c.forEach(function (t) {
        ...
        arcs: f.map(function (n) {
          ...
          if (n.forEach(function (t) {
            ...
            }), r = Object(o.a)(t, r), (e = r.length) > 1)
            for (var i, c, f = 1, s = u(r[0]); f < e; ++f)(i = u(r[f])) > s && (c = r[0], r[0] = r[f], r[f] = c, s = i);
          return r
        })
      }
    }
    ...
    n.a = function (t, n) {
      ...
      if (n && n.scale) l = t.bbox;
        ...
        var u, a = (l = t.bbox || Object(r.a)(t))[0],
          c = l[1],
          f = l[2],
          s = l[3];
        n = {
    ...
    function i(t, n) {
      ...
      if (h.forEach(function (t) {
        ...
        e.forEach(function (t) {
          var n = c.map(function (n) {
            return t[n]
          }).join("-"); - 1 === g.indexOf(n) && (g.push(n), b[n] = t)
        });
    ...
    }), y.average = y.mean, p("aggregate", r), p("summary", r), t.exports = {
          ...
          ! function (t, n) {
            ...
            if (u !== r + 1) {
              ...
              for (h = 0, ++r; r < u; ++h, ++r) c.points = [], l = {
                ...
                edgeObj: n,
                rank: r
              }, s = i.addDummyNode(t, "edge", l, "_d"), r === f && (l.width = c.width, l.height = c.height, l.dummy = "edge-label", l.labelpos = c.labelpos), t.setEdge(e, s, {
                weight: c.weight
              }, a), 0 === h && t.graph().dummyChains.push(s), e = s;
              t.setEdge(e, o, {
                weight: c.weight
              }, a)
            }
    ...
    function s(t, n, e, r) {
      var o = e.v,
        a = e.w;
      t.removeEdge(o, a), t.setEdge(r.v, r.w, {}), u(t), i(t, n),
        function (t, n) {
    ...
    t.exports = function (t) {
      ...
      r.forEach(t.graph().dummyChains, function (e) {
        for (var r = t.node(e), i = r.edgeObj, o = function (t, n, e, r) {
          ...
          if (r = t.node(e), s) {
            for (;
              (f = u[c]) !== a && t.node(f).maxRank < r.rank;) c++;
            f === a && (s = !1)
          }
          if (!s) {
    ...
    function r(t, n, e, r, i, u) {
      ...
      i[n][u] = f, t.setParent(f, r), c && t.setEdge(c, f, {
        weight: 1
      })
    }
    var i = e(8),
    ...
    function r(t, n) {
      ...
      var r = c().links(function (t) {
        return t.edges
      }).nodeWidth(n.nodeWidth).nodePadding(n.nodePadding).extent([
        [0, 0],
        [1, 1]
      ]);
    ...
    n.a = function () {
          ...
          function (t) {
            function n() {
              e.forEach(function (t) {
                ...
                if ((e = i - m - O) > 0)
                  for (i = n.y0 -= e, n.y1 -= e, r = u - 2; r >= 0; --r) n = t[r], (e = n.y1 + m - i) > 0 && (n.y0 -= e, n.y1 -= e), i = n.y0
              })
            }
      ...
      return t.update = function (t) {
        ...
        return arguments.length ? (e = +n[0][0], j = +n[1][0], y = +n[0][1], O = +n[1][1], t) : [
          [e, y],
          [j, O]
        ]
      ...
      lineEnd: function () {
        ...
        if (e)
          if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]);
            ...
            for (var r = i(t), o = i(n), u = 0, a = 1; a < e; ++u, ++a) this._context.bezierCurveTo(r[0][u], o[0][u], r[1][u], o[1][u], t[a], n[a]);
    ...
    n.a = function () {
      ...
      return t.polygons = function (n) {
        ...
        return arguments.length ? (u = null == n ? null : [
          [+n[0][0], +n[0][1]],
          [+n[1][0], +n[1][1]]
        ], t) : u && [
          [u[0][0], u[0][1]],
            ...
            ! function (t, n, e) {
              ...
              for (; null !== r && null !== o;) {
                ...
                a > 0 && (u += a, function (t, n, e, r) {
                  t.c[n].mod += r, t.c[n].msel += r, t.c[n].mser += r,
                    function (t, n, e, r) {
                      if (e !== n - 1) {
                        var i = n - e;
    ...
    function i(t) {
      ...
      if (e) {
        ...
        if (n.forEach(function (t) {
            a += t.totalHeight
          }), u > t.height) t.y = r.y + u / 2 - t.height / 2;
    ...
    t.exports = function (t, n) {
      void 0 === n && (n = {}), n = o.assign({}, u, n), t.parent = {
        ...
        if (e) {
          var r = n[0];
          if (r.startY = t.startY + t._subTreeSep, 1 === e) r.y = t.y + t.height / 2 - r.height / 2;
          else {
      ...
      return C.canvas = function (t) {
        ...
        var e = t,
          ...
          o = function (t) {
            ...
            return e.fillStyle = e.strokeStyle = "red", e.textAlign = "center", {
              context: e,
              ratio: n
            }
          }(k()),
        ...
        return function () {
          for (var n = Date.now(); Date.now() - n < T && ++d < a;) {
            ...
            e.x = r * (S() + .5) >> 1, e.y = i * (S() + .5) >> 1, c(o, e, v, d), e.hasText && function (n, e, r) {
              for (var i, o, u, a = e.x, c = e.y, s = Math.sqrt(t[0] * t[0] + t[1] * t[1]), h = E(t), p = S() < .5 ? 1 : -1, v = -p;
                (i = h(v += p)) && (o = ~~i[0], u = ~~i[1], !(Math.min(Math.abs(o), Math.abs(u)) >= s));)
                if (e.x = a + o, e.y = c + u, !(e.x + e.x0 < 0 || e.y + e.y0 < 0 || e.x + e.x1 > t[0] || e.y + e.y1 > t[1]) && (!r || !f(e, n, t[0])) && (!r || l(e, r))) {
    ...
    var i = e(3),
      ...
      g = f(l);
    h("kernel-smooth.density", r), h("kernel.density", r), t.exports = {
      KERNEL_METHODS: g
    }
  }, function (t, n, e) {
    function r(t) {
    ...
    var o = e(3),
      ...
      j = l(v);
    d("kernel-smooth.regression", i), d("kernel.regression", i), t.exports = {
      KERNEL_METHODS: j
    }
  }])
});