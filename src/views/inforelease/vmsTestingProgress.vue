<template>
  <div class="dp">
    <div class="pvptop2">VMS检测进度</div>
    <div style="padding-left: 0px">
      <el-carousel indicator-position="none" height="750px" :interval="3000" @change="progress">
...
export default {
  ...
  methods: {
    async vmsdata() {
      const res = await this.$http.get("vmstestsechedule");
